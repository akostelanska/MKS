...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
//definícia bufferu a indexu �?ítania/zápisu
...
/* USER CODE BEGIN PV */
//premenné pre def. bufferu a indexu �?ítania/zápisu
